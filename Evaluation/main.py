...
def score_video_mot_file(output_dir, model_path):
    ...
    try:
        ...
        return overall_score, gpt_feedback
...
def generate_gpt_feedback(overall_score, feedback):
    try:
        ...
        # Make API call to OpenAI to generate feedback
        ...
        gpt_feedback = response.choices[0].text.strip()
        return gpt_feedback
    except Exception as e:
...
def evaluate_video(video_path):
    ...
    try:
        ...
        overall_score, gpt_feedback = score_video_mot_file(output_dir, model_path)
